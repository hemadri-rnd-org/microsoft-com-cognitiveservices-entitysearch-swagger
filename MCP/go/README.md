# Entity Search Client MCP Server

This MCP (Model Content Protocol) server provides access to Entity Search Client API functionality through HTTP, HTTPS, and STDIO transport modes.
